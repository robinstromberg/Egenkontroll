...
export const knowledgeRouteGovernance = [
  ...
  transitional('/seo/grundforutsattningar-livsmedel.html', 'fact-page', 'prerequisites', '/kunskapsbank'),
  ...
  transitional('/seo/lokaler-och-utrustning-livsmedel.html', 'fact-page', 'premises-equipment', '/kunskapsbank'),
