...
export const knowledgeSources = {
  'kontrollwiki:246': {
    ...
    sections: [
      ...
      { id: 'grundforutsattning-eller-haccp', label: 'Grundförutsättning eller HACCP' },
      { id: 'j02-utformning-och-underhall-av-lokaler-och-utrustning', label: 'J02 - Utformning och underhåll av lokaler och utrustning' },
      { id: 'j03-hygien-fore-under-och-efter-processen', label: 'J03 - Hygien före, under och efter processen' },
      { id: 'j08-uppratthallande-av-kylkedjan-och-uppfyllande-av-temperaturkriterier', label: 'J08 - Upprätthållande av kylkedjan och uppfyllande av temperaturkriterier' },
    ],
  ...
  'kontrollwiki:341': {
    ...
    relevantSections: ['Hygienisk hantering', 'Krav på avfallsutrymmen'],
    latestVersion: '2024-01-26',
    sections: [
      { id: 'hygienisk-hantering', label: 'Hygienisk hantering' },
      { id: 'krav-pa-avfallsutrymmen', label: 'Krav på avfallsutrymmen' },
    ],
  ...
  'kontrollwiki:343': {
    ...
    sections: [
      { id: 'lokaler-for-livsmedelsforetagare', label: 'Lokaler för livsmedelsföretagare' },
      { id: 'inredning-och-materialval', label: 'Inredning och materialval' },
      { id: 'underhall', label: 'Underhåll' },
      { id: 'ovriga-utrymmen', label: 'Övriga utrymmen' },
      { id: 'offentlig-kontroll-av-lokalernas-utformning', label: 'Offentlig kontroll av lokalernas utformning' },
    ],
  ...
  'kontrollwiki:350': {
    ...
    factCheckedAt: '2026-07-18',
    accessedAt: '2026-07-18',
    relevantSections: ['Allmänt om livsmedel under transport'],
    latestVersion: '2026-03-06',
    sections: [{ id: 'allmant-om-livsmedel-under-transport', label: 'Allmänt om livsmedel under transport' }],
  ...
  'kontrollwiki:351': {
    ...
    factCheckedAt: '2026-07-18',
    accessedAt: '2026-07-18',
    relevantSections: ['Utbildning och kunskap'],
    latestVersion: '2026-02-24',
    sections: [{ id: 'utbildning-och-kunskap', label: 'Utbildning och kunskap' }],
  ...
  'kontrollwiki:352': {
    ...
    factCheckedAt: '2026-07-18',
    accessedAt: '2026-07-18',
    relevantSections: ['Krav på livsmedelsföretag och vatten', 'Vad gäller för is?'],
    latestVersion: '2025-09-30',
    sections: [
      { id: 'krav-pa-livsmedelsforetag-och-vatten', label: 'Krav på livsmedelsföretag och vatten' },
      { id: 'vad-galler-for-is', label: 'Vad gäller för is?' },
    ],
    legalReference: 'Förordning (EG) nr 852/2004, bilaga II kapitel VII',
    limitationId: 'disclaimer:kontrollwiki-guidance:v1',
  },
  'kontrollwiki:1045': {
    id: 'kontrollwiki:1045',
    label: 'Livsmedelsverkets Kontrollwiki: Toaletter och handfat',
    url: 'https://kontrollwiki.livsmedelsverket.se/artikel/1045/toaletter-och-handfat',
    type: 'myndighetsvägledning',
    factCheckedAt: '2026-08-01',
    accessedAt: '2026-08-01',
    relevantSections: ['Handfat'],
    latestVersion: '2026-04-13',
    sections: [{ id: 'handfat', label: 'Handfat' }],
    legalReference: 'Förordning (EG) nr 852/2004, bilaga II kapitel I',
    limitationId: 'disclaimer:kontrollwiki-guidance:v1',
  },
  'kontrollwiki:1046': {
    id: 'kontrollwiki:1046',
    label: 'Livsmedelsverkets Kontrollwiki: Ventilation',
    url: 'https://kontrollwiki.livsmedelsverket.se/artikel/1046/ventilation',
    type: 'myndighetsvägledning',
    factCheckedAt: '2026-08-01',
    accessedAt: '2026-08-01',
    relevantSections: ['Ventilation'],
    latestVersion: '2026-04-13',
    sections: [{ id: 'ventilation', label: 'Ventilation' }],
    legalReference: 'Förordning (EG) nr 852/2004, bilaga II kapitel I',
    limitationId: 'disclaimer:kontrollwiki-guidance:v1',
  },
