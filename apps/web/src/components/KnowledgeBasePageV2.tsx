...
export function KnowledgeBasePage() {
  ...
  return <main className="public-site">
    <nav className="public-nav" aria-label="Publik navigation"><a className="public-brand" href="/"><img src={brandAssets.logo} alt="Min Egenkontroll" /></a><div className="public-nav-actions"><a href="/">Startsida</a><a href={appUrls.signup}>Gå med</a></div></nav>
    ...
    <section className="public-cta"><p className="public-eyebrow">Från kunskap till vardag</p><h2>Samla kontroller, avvikelser och historik på ett ställe.</h2><a className="public-primary" href={appUrls.signup}>Gå med i förhandslanseringen</a></section>
