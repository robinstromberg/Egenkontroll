...
export function Homepage() {
  ...
  return <PublicSiteShell>
    <main id="main-content">
      <section className="home-hero"><div className="home-shell home-hero__grid"><div><p className="home-kicker">Egenkontroll för små livsmedelsverksamheter</p><h1>Få koll på det som ska göras. Varje dag.</h1><p className="home-lead">Min Egenkontroll hjälper restauranger, caféer, bagerier, butiker och foodtrucks att förstå, dokumentera och följa upp egenkontrollen.</p><div className="home-actions"><a className="ds-button ds-button--primary" href="#hjalp">Hitta rätt hjälp</a><a className="ds-button ds-button--secondary" href="/signup">Kom igång med appen</a></div><p className="home-note">Kunskap när du behöver förstå. Appen när arbetet återkommer.</p></div><AppProof /></div></section>
      ...
      <section className="home-ending"><div className="home-shell"><div><p className="home-kicker">Nästa steg</p><h2>Börja där du behöver det mest.</h2></div><div className="home-actions"><a className="ds-button ds-button--primary" href="/signup">Kom igång med appen</a><LinkButton href="/kunskapsbank" variant="secondary">Hitta rätt hjälp</LinkButton></div></div></section>
    </main>
  </PublicSiteShell>;
}
