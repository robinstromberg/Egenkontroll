...
- paketroten: `Alert`, `Badge`, `Button`, `LinkButton`, `Card`, `Field`, `SearchField`, `TextField` samt de exporterade typerna `ButtonVariant`, `StatusTone` och `FieldControlProps`,
...
Den fullständiga rebrandchecklistan och guardrailreglerna finns i `docs/DESIGN_SYSTEM_CORE.md`. Alla komponenttillstånd verifieras i appens dev-showcase och enligt `apps/app/src/theme/QA_MATRIX.md`.
