...
export const verifieringHaccpFactPage: FactPageContent = {
  ...
  sequentialNextStep: { eyebrow: 'Fortsätt i arbetsordning', href: '/haccp-sma-livsmedelsforetag', title: 'Sätt verifieringen i ett HACCP-sammanhang', copy: 'Gå till HACCP-navet för att se hela kedjan från faroanalys till uppföljning.', linkLabel: 'Till HACCP och riskstyrning' },
