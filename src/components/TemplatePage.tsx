...
export function TemplatePage({ content, onLogin, onStartTrial }: TemplatePageProps) {
  ...
  return <PublicSiteShell className="template-page" onLogin={onLogin} onStartTrial={onStartTrial}>
