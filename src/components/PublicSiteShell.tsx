...
const links = [['/kunskapsbank', 'Kunskap'], ['/mall-kontrollplan-livsmedel', 'Mallar och checklistor'], ['/verktyg-faroanalys-livsmedel', 'Verktyg'], ['/seo/utbildning-livsmedelshygien-personal.html', 'Utbildning'], ['/seo/kallor-och-faktagranskning.html', 'Referenser och källor'], ['/digital-egenkontroll-livsmedel', 'Appen']] as const;
...
export function PublicSiteShell({ children, onStartTrial, onLogin, className = '' }: Props) {
  ...
  return <div className={`home-page ${className}`} data-theme={theme}>
    ...
    {children}
    <footer className="home-footer"><div className="home-shell"><span>© 2026 Min Egenkontroll</span><nav><a href="/kunskapsbank">Kunskap</a><a href="/mall-kontrollplan-livsmedel">Mallar</a><a href="/verktyg-faroanalys-livsmedel">Verktyg</a><a href="/digital-egenkontroll-livsmedel">Appen</a><a href="/integritetspolicy">Integritet</a><a href="/anvandarvillkor">Villkor</a></nav></div></footer>
  </div>;
}
